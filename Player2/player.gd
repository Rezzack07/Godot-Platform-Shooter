...
func _ready() -> void:
	...
	animated_sprite_2d.modulate = Color(1,1,1,1) # reset red tint tiap load scene
	hit_animation_player.stop(true) # hard reset hit animation
...
func player_death():
	...
	print("GameOver instance created")
...
func _on_hurtbox_body_entered(body: Node2D) -> void:
	...
	if body.is_in_group("Enemy"):
		if body.get("damage_amount") != null :
